...
# Lab 06
# Lab Section: 15
# Sources, people worked with, help given to: Alec stevens Ever Jhonson 
# your
# comments
# here
...
for characters in random_string:
    if characters not in character.keys():
        character[characters] = 1
    else:
        character[characters] += 1

for char in sorted(character.keys()):
